  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white">
      ...
      <div className="button-container">
        ...
        <button className="button"onClick={() =>setInputType("text")}>Enter Text</button>
      </div>
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <form onSubmit={handleSubmit}>
                  ...
                  {inputType === "audio" && (
                    <>
                      ...
                      {((file ) && <button
                        ...
                        className={"flex items-center justify-center px-4 py-2 border rounded-md bg-green-500 text-white"}
                      >
                       Proceed 
                      </button>)}
            ...
            )}
            {
              ...
              (descriptionText || convertedText )&& (<div className="flex justify-center mt-6">
              <button
                type="submit"
